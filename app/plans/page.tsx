      ...
      >
        {plans.map((plan, idx) => (
          ...
          >
            ...
            <div
              className={`mt-2 ${plan.popular ? "text-squito-green" : "text-gray-900"}`}
            >
              ...
              <p
                className={`mt-3 text-[13px] font-medium ${plan.popular ? "text-squito-green/80" : "text-gray-500"}`}
              >
                {plan.desc}
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3 border-t border-gray-100 pt-6">
              {plan.features.map((feat, fidx) => (
                <div key={fidx} className="flex items-center gap-3">
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#f4fae6] text-[10px] text-squito-green">
                    ✓
                  </span>
            ...
            <GlassButton
              ...
              className={`mt-8 w-full py-4 text-[15px] ${plan.popular ? "bg-squito-green/90 dark:bg-squito-green" : "border-gray-200 text-gray-900"}`}
            >
              Select Plan
            </GlassButton>
          </motion.div>
