...
const feedData = [
  {
    ...
    description:
      "Watch how our technicians create a 21-day barrier against Long Island ticks. Your yard should be a sanctuary, not a threat. 🛡️ #pestcontrol #longisland",
    likes: "12.4K",
    comments: "342",
    animation: undefined,
  },
  {
    ...
    username: "@squitoprotect",
    description:
      "Did you know ticks wait on the tips of tall grass to latch onto you? This is called 'questing'. We eliminate them before they get the chance. 🕷️⚠️ #ticks",
    likes: "8.9K",
    comments: "156",
  ...
  },
  {
    ...
    username: "@squitoprotect",
    description:
      "The fleet rolling out for the spring rush! Did you schedule your seasonal barrier yet? Trucks are filling up fast. 🚐💨 #squitosquad #bts",
    likes: "2.1K",
    comments: "48",
  ...
  },
  {
    ...
    username: "@squitoprotect",
    description:
      "What we found under this customer's house is nightmare fuel. This is why annual inspections are mandatory. 🔦🐀 #pestcontrol #horrortok",
    likes: "95.2K",
    comments: "4.5K",
  ...
  },
  {
    ...
    username: "@squitoprotect",
    description:
      "Do NOT attempt to knock these down yourself. The paper hornet is aggressive and attacks in swarms. Call a professional. 🐝🛑 #hornets #danger",
    likes: "54.8K",
    comments: "2.1K",
  ...
  },
  {
    ...
    username: "@squitoprotect",
    description:
      "The result of a properly treated yard. No grubs, no ticks, no mosquitoes. Just summer perfection. ☀️🏡 #lawncare #dreamhome",
    likes: "18.3K",
    comments: "215",
  ...
  },
  {
    ...
    username: "@squitoprotect",
    description:
      "A bug-free kitchen is a happy kitchen. Ask about our Ultimate Plan for complete indoor/outdoor coverage. ✨ #cleanhouse #peaceofmind",
    likes: "6.7K",
    comments: "89",
  ...
  },
  {
    ...
    username: "@squitoprotect",
    description:
      "A single crumb can summon the whole colony. If you see one ant, there are thousands behind the walls. We destroy the nest. 🐜💥 #ants ",
    likes: "45.1K",
    comments: "1.2K",
...
const pestComments = [
  {
    user: "@MosquitoKing_99",
    icon: "🦟",
    time: "2h ago",
    text: "You guys are literally ruining my summer. I just wanted ONE bite bro! ONE! 😡",
    likes: "12.4K",
  },
  {
    user: "@TickBoy3000",
    icon: "🕷️",
    time: "4h ago",
    text: "Squito is a scam. High grass is totally safe guys, come lay in it. Trust me.",
    likes: "8.1K",
  },
  {
    user: "@QueenAnt",
    icon: "🐜",
    time: "5h ago",
    text: "We were just trying to build a family in your kitchen walls! The disrespect...",
    likes: "5.2K",
  },
  {
    user: "@RoachBoss",
    icon: "🪳",
    time: "8h ago",
    text: "You can't get rid of me. I survived the literal dinosaurs. Nice try tho.",
    likes: "14.9K",
  },
  {
    user: "@WaspyBoi",
    icon: "🐝",
    time: "1d ago",
    text: "I dare the technician to swing by my nest again. The squad is READY. 🥊",
    likes: "9.3K",
  },
  {
    user: "@MouseInTheHouse",
    icon: "🐀",
    time: "3d ago",
    text: "1 star review. Your barrier treatment evicted me. Now I live in the neighbor's shed.",
    likes: "1.1K",
  },
];
...
function FeedItem({
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        if (entry.isIntersecting) {
          if (videoRef.current) {
            // The Promise from play() helps catch if autoPlay gets strictly blocked
      ...
      { threshold: 0.6 },
    ); // Requires at least 60% of the video to be in viewport to count
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-full w-full snap-start snap-always overflow-hidden bg-[#111]"
    >
...
export default function TikTokFeed() {
  ...
  const [feed, setFeed] = useState(feedData); // Default to ordered for server hydration

  useEffect(() => {
    async function loadFeedData() {
      // 1. Attempt to grab videos from the real Supabase backend!
      if (supabase) {
        const { data, error } = await supabase.from("feed_videos").select("*");
        if (!error && data && data.length > 0) {
          setFeed([...data].sort(() => Math.random() - 0.5));
          return; // Successfully loaded from Cloud!
        }
      }

      // 2. Fallback to our dummy data if the database isn't hooked up yet
                  ...
                  {pestComments.map((comment, idx) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="mt-1 text-[14px] leading-snug text-gray-700">
                          {comment.text}
                        </p>
                      </div>
