      ...
      {isDrawerOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[9600] flex max-h-[85vh] flex-col rounded-t-[28px] border-t border-gray-200 bg-white shadow-[0_-8px_30px_rgba(0,0,0,0.12)]"
          >
            {/* Handle + Header */}
            <div className="flex flex-col items-center px-5 pt-3 pb-2">
              <div className="h-1 w-10 rounded-full bg-gray-300 mb-4" />
              <div className="flex w-full items-center justify-between">
                ...
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-500 active:scale-90 transition-transform"
                >
                  ✕
                </button>
              </div>
            ...
            {!hasItems && (
              <div className="flex flex-1 flex-col items-center justify-center px-8 py-12 text-center">
                ...
                <p className="mt-2 text-[13px] font-medium text-gray-500 max-w-xs">
            ...
            {hasItems && (
              <>
                <div className="flex-1 overflow-y-auto px-5 pb-2 divide-y divide-gray-100">
                  {items.map((item, idx) => (
                    <motion.div
                      key={item.serviceKey}
                    ...
                    >
                      ...
                      <button
                        ...
                        className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-red-50 text-red-400 transition-all active:scale-90 active:bg-red-100"
                      >
                ...
                {/* Summary + Actions */}
                <div className="border-t border-gray-100 bg-gray-50/50 px-5 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))]">
